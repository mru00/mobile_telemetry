...
public class SelectDeviceActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setTitle(cc.teil.sisyphus.mru.mobiletelemetry.R.string.title_devices);
        mHandler = new Handler();

        // Use this check to determine whether BLE is supported on the device.  Then you can
        // selectively disable BLE-related features.
        if (!getPackageManager().hasSystemFeature(PackageManager.FEATURE_BLUETOOTH_LE)) {
            Toast.makeText(this, cc.teil.sisyphus.mru.mobiletelemetry.R.string.ble_not_supported, Toast.LENGTH_SHORT).show();
            finish();
        }
        ...
        if (mBluetoothAdapter == null) {
            Toast.makeText(this, cc.teil.sisyphus.mru.mobiletelemetry.R.string.error_bluetooth_not_supported, Toast.LENGTH_SHORT).show();
            finish();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case cc.teil.sisyphus.mru.mobiletelemetry.R.id.menu_scan:
                mLeDeviceListAdapter.clear();
                scanLeDevice(true);
                break;
            case cc.teil.sisyphus.mru.mobiletelemetry.R.id.menu_stop:
                scanLeDevice(false);
                break;
        }
        return true;
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (deviceName != null && deviceName.length() > 0)
                ...
                viewHolder.deviceName.setText(cc.teil.sisyphus.mru.mobiletelemetry.R.string.unknown_device);
